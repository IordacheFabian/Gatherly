...
export default function RegisterForm() {
  ...
  const loading = registerUser.isPending || isSubmitting;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Welcome to the platform — enter your credentials to continue.
        </Typography>
        ...
        <Box sx={{ width: "100%", mt: 1 }}>
          <TextInput control={control} name="displayName" label="Display Name" fullWidth />
        </Box>

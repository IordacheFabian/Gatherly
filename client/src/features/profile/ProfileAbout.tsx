  ...
  return (
    <Box>
      <Box display="flex" justifyContent="space-between">
        <Typography variant="h5" sx={{ color: "white"}}>About {profile?.displayName}</Typography>
        <Button
          sx={{
            position: "relative",
            overflow: "hidden",
      ...
      >
        {editMode ? (
          ...
          <Typography variant="body1" sx={{ whiteSpace: "pre-wrap", color: "lightgray", fontWeight: 20, textAlign: 'justify' }}>
